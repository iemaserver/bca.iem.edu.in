document.querySelector("footer").innerHTML = ` <div class="footer_widget_area">
<div class="container">
  <div class="row">
            ...
            <ul class="page_list unordered_list_block">
              <li>
                <a href="about.html">
                  ...
                  <span class="item_text">Library</span>
                </a>
              </li>
              <li>
                <a href="course.html">
                  <span class="item_icon"><i class="fas fa-caret-right"></i></span>
                  <span class="item_text">Professional Societies</span>
                </a>
              </li>
              <li>
                <a href="mentor.html">
                  <span class="item_icon"><i class="fas fa-caret-right"></i></span>
                  <span class="item_text">CSR Activity</span>
                </a>
              </li>
              <li>
                <a href="pricing.html">
                  <span class="item_icon"><i class="fas fa-caret-right"></i></span>
                  <span class="item_text">Newsletter</span>
                </a>
              </li>
              <li>
                <!-- <a href="event.html">
          ...
          <div class="footer_widget">
            ...
            <ul class="page_list unordered_list_block">
              <li>
                <a href="#!">
                  <span class="item_icon"><i class="fas fa-caret-right"></i></span>
                  <span class="item_text">Advisory Board</span>
                </a>
              </li>
              <li>
                <a href="#!">
                  <span class="item_icon"><i class="fas fa-caret-right"></i></span>
                  <span class="item_text">Alumni</span>
                </a>
              </li>
              <li>
                <a href="#!">
                  <span class="item_icon"><i class="fas fa-caret-right"></i></span>
                  <span class="item_text">Consultancy & Collaboration</span>
                </a>
              </li>
              <li>
                <a href="#!">
                  <span class="item_icon"><i class="fas fa-caret-right"></i></span>
                  <span class="item_text">Feedback</span>
                </a>
              </li>
              <li>
                <!-- <a href="#!">
          ...
          <li>
            <a class="blog_small" href="blog_details.html">
              <span class="item_image">
                <img src="assets/images/Hackathon.jpg" alt="Collab – Online Learning Platform">
              </span>
              <span class="item_content">
                <span class="item_author"><i class="fas fa-user-alt"></i> by Corabelle Durrad</span>
                <strong class="item_title">BCA 2nd year team Secured 2nd position in Diversion (Hackathon)</strong>
                <small class="item_post_date">February 04, 2024</small>
              </span>
            </a>
          </li>
          <li>
            <a class="blog_small" href="https://www.facebook.com/iembca?__cft__[0]=AZX5LaEhGOHyB_NM0iHVGA0aO03RMMkJr5xhJrtdyCiLYTctU-eqck88JetjCtbLJOB4APGHsWzxH7-2c2zD19SY-og8efAIG0EhGnY4DrPVEdW9kUVy203NuednAVxHCAZNpq-O03fN-KfvfTq8klJLa_i1sgccUZ3CQTwsxkI--LMJpwvPeCGMOWqR2IGMpnqgMzxv8nN1sGzUidogqTa8&__tn__=-UC%2CP-R">
              <span class="item_image">
                <img src="assets/images/Amazon.png" alt="Collab – Online Learning Platform">
              </span>
              <span class="item_content">
                <span class="item_author"><i class="fas fa-user-alt"></i> by Corabelle Durrad</span>
                <strong class="item_title">Campus for 2020 passout batch</strong>
                <small class="item_post_date">January 12, 2020</small>
              </span>
            </a>
          </li>
        </ul>
